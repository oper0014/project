...
<head>
<link rel="stylesheet" href="/struts2/board/common/css/css.css"
	type="text/css">
	...
	<table width="600" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td align="right" colspan="2"><s:url id="modifyURL"
				...
				onClick="javascript:open_win_noresizable('checkForm2.action?no=<s:property value="resultClass.no" />&currentPage=<s:property value="currentPage" />','modify')">

				<input name="list" type="button" value="삭제" class="inputb"
				onClick="javascript:open_win_noresizable('checkForm2.action?no=<s:property value="resultClass.no" />&currentPage=<s:property value="currentPage" />','delete')">

				<input name="list" type="button" value="목록" class="inputb"
				onClick="javascript:location.href='majorlist.action?currentPage=<s:property value="currentPage" />'">
